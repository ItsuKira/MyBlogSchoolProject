...
class Comment(db.Model):
    ...
    # Create Foreign Key, "post.id" the users refers to the tablename of BlogPost.
    post_id = db.Column(db.Integer, db.ForeignKey('blog_posts.id'))
    # Create reference to the BlogPost object, the "comments" refers to the posts property in the BlogPost class.
